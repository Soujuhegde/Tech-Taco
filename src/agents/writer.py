...
class WriterAgent:
    ...
    def _draft(self, selection) -> GeneratedPost:
        ...
        prompt = (
            ...
            "Also write a separate short Mastodon post. Strictly follow this to sound like a real person, not an AI:\n"
            "- Write in a natural, conversational tone.\n"
            "- Include a personal reaction, observation, or curiosity.\n"
            "- Avoid corporate or news-anchor language.\n"
            "- Avoid words like 'breakthrough', 'revolutionary', 'game-changing', 'transforming'.\n"
            "- Do not sound overly polished. Use short paragraphs.\n"
            "- End with a thoughtful question or insight when appropriate.\n"
            "- Use at most one hashtag.\n"
            "- Make it feel like someone genuinely discovered and wanted to share the story.\n"
            "Example vibe: '[Summary of what happened]. What fascinated me wasn\\'t the technology itself, but the fact that it gave someone a way to communicate again. That\\'s the kind of AI application that really matters.'\n\n"
